...
do
  echo "$i START"
	./Dial -d ch9-1.1/inputs/Long-C/Long-C.$i.0.gr -ss ch9-1.1/inputs/Long-C/Long-C.$i.0.ss -oss results/longc/longc_$i.dial.ss.res
  echo "$i END"
done
...
do
  echo "$i START"
	./Dial -d ch9-1.1/inputs/Long-n/Long-n.$i.0.gr -ss ch9-1.1/inputs/Long-n/Long-n.$i.0.ss -oss results/longn/longn_$i.dial.ss.res
  echo "$i END"
done
...
do
  echo "$i START"
	./Dial -d ch9-1.1/inputs/Random4-n/Random4-n.$i.0.gr -ss ch9-1.1/inputs/Random4-n/Random4-n.$i.0.ss -oss results/random4n/random4n_$i.dial.ss.res
  echo "$i END"
done
...
do
  echo "$i START"
	./Dial -d ch9-1.1/inputs/Square-n/Square-n.$i.0.gr -ss ch9-1.1/inputs/Square-n/Square-n.$i.0.ss -oss results/squaren/squaren_$i.dial.ss.res
  echo "$i END"
done
...
do
  echo "$i START"
	./Dial -d ch9-1.1/inputs/Square-C/Square-C.$i.0.gr -ss ch9-1.1/inputs/Square-C/Square-C.$i.0.ss -oss results/squarec/squarec_$i.dial.ss.res
  echo "$i END"
done
...
./Dial -d ch9-1.1/inputs/USA-road-t/USA-road-t.BAY.gr -ss ch9-1.1/inputs/USA-road-t/USA-road-t.BAY.ss -oss results/USA-road-t/USA-road-t.BAY.dial.ss.res
...
./Dial -d ch9-1.1/inputs/USA-road-t/USA-road-t.CAL.gr -ss ch9-1.1/inputs/USA-road-t/USA-road-t.CAL.ss -oss results/USA-road-t/USA-road-t.CAL.dial.ss.res
...
./Dial -d ch9-1.1/inputs/USA-road-t/USA-road-t.COL.gr -ss ch9-1.1/inputs/USA-road-t/USA-road-t.COL.ss -oss results/USA-road-t/USA-road-t.COL.dial.ss.res
...
./Dial -d ch9-1.1/inputs/USA-road-t/USA-road-t.CTR.gr -ss ch9-1.1/inputs/USA-road-t/USA-road-t.CTR.ss -oss results/USA-road-t/USA-road-t.CTR.dial.ss.res
...
./Dial -d ch9-1.1/inputs/USA-road-t/USA-road-t.E.gr -ss ch9-1.1/inputs/USA-road-t/USA-road-t.E.ss -oss results/USA-road-t/USA-road-t.E.dial.ss.res
...
./Dial -d ch9-1.1/inputs/USA-road-t/USA-road-t.FLA.gr -ss ch9-1.1/inputs/USA-road-t/USA-road-t.FLA.ss -oss results/USA-road-t/USA-road-t.FLA.dial.ss.res
...
./Dial -d ch9-1.1/inputs/USA-road-t/USA-road-t.LKS.gr -ss ch9-1.1/inputs/USA-road-t/USA-road-t.LKS.ss -oss results/USA-road-t/USA-road-t.LKS.dial.ss.res
...
./Dial -d ch9-1.1/inputs/USA-road-t/USA-road-t.NE.gr -ss ch9-1.1/inputs/USA-road-t/USA-road-t.NE.ss -oss results/USA-road-t/USA-road-t.NE.dial.ss.res
...
./Dial -d ch9-1.1/inputs/USA-road-t/USA-road-t.NW.gr -ss ch9-1.1/inputs/USA-road-t/USA-road-t.NW.ss -oss results/USA-road-t/USA-road-t.NW.dial.ss.res
...
./Dial -d ch9-1.1/inputs/USA-road-t/USA-road-t.NY.gr -ss ch9-1.1/inputs/USA-road-t/USA-road-t.NY.ss -oss results/USA-road-t/USA-road-t.NY.dial.ss.res
...
./Dial -d ch9-1.1/inputs/USA-road-t/USA-road-t.W.gr -ss ch9-1.1/inputs/USA-road-t/USA-road-t.W.ss -oss results/USA-road-t/USA-road-t.W.dial.ss.res
