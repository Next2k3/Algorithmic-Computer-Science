...
-- add peterson
  procedure Peterson_Entry(Proc_Id : Integer) is
      Other : constant Integer := 1 - Proc_Id;
  begin
      Flag(Proc_Id) := True;
      Turn := Other;
  ...
  procedure Peterson_Exit(Proc_Id : Integer) is
  begin
      Flag(Proc_Id) := False;
  end Peterson_Exit;
--
