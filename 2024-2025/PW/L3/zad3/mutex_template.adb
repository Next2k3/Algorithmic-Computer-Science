...
-- add dekker entry
  procedure Entry_Protocol_Dekker(Id: Integer) is
    Other : constant Integer := 1 - Id;
  begin
    Flag(Id) := True;
  ...
  end Entry_Protocol_Dekker;
--

-- add dekker exit
  procedure Exit_Protocol_Dekker(Id: Integer) is
  begin
    Turn := 1 - Id;
    Flag(Id) := False;
  end Exit_Protocol_Dekker;
--
...
-- add here ofcorsss
      Entry_Protocol_Dekker(Process.Id);
--
...
-- add here ofcorsss
      Exit_Protocol_Dekker(Process.Id);
--
